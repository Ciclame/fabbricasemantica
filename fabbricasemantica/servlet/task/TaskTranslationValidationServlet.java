...
public class TaskTranslationValidationServlet extends BaseServlet 
{
	...
	/**
	 * Il metodo viene invocato dopo la chiamata alla servlet all'indirizzo 'translationValidation.jsp' 
	 * e:
	 * <ul>
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(request.getParameter("next") != null && request.getParameter("traduzioni") != null)
		{	
			List<Map<String, Object>> result = Database.executeQuery("INSERT INTO usertask(username, task, risultato) VALUES('"
				+ request.getSession().getAttribute("username") + "', 'translationvalidation', " 
				+ "'Bottone premuto numero: "+ request.getParameter("traduzioni") + "') returning username");
		...
		{			
			...
			out.println("alert('Scegliere una delle traduzioni proposte prima di premere il pulsante next');");
			out.println("location='TranslationValidation.html';");
			out.println("</script>");
		}
	}
