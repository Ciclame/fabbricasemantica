...
public class TaskSenseAnnotationServlet extends BaseServlet {
	...
	/**
	 * Il metodo viene invocato dopo la chiamata alla servlet all'indirizzo 'senseAnnotation.jsp' 
	 * e:
	 * <ul>
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(request.getParameter("next") != null && request.getParameter("significati") != null)
		{	
			List<Map<String, Object>> result = Database.executeQuery("INSERT INTO usertask(username, task, risultato) VALUES('"
				+ request.getSession().getAttribute("username") + "', 'senseannotation', 'Bottone premuto numero: " 
				+ request.getParameter("significati") + "') returning username");
		...
		{	
			...
			out.println("alert('Scegliere una delle opzioni proposte prima di premere il pulsante next');");
			out.println("location='SenseAnnotation.html';");
			out.println("</script>");
		}
	}
