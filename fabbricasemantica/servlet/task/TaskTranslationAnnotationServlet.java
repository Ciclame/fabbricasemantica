...
public class TaskTranslationAnnotationServlet extends BaseServlet 
{
	...
	/**
	 * Il metodo viene invocato dopo la chiamata alla servlet all'indirizzo 'translationAnnotation.jsp' 
	 * e:
	 * <ul>
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{		
			List<Map<String, Object>> result = Database.executeQuery("INSERT INTO usertask(username, task, risultato) VALUES('"
				+ request.getSession().getAttribute("username") + "', 'translationannotation', '" 
				+ "Traduzione fornita: " + request.getParameter("traduzione") + "') returning username");
		...
		{			
			...
			out.println("alert('Fornire una traduzione appropriata prima di premere il pulsante next');");
			out.println("location='TranslationAnnotation.html';");
			out.println("</script>");
		}
	}
